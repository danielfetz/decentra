...
const SafeAppsListHeader = ({ amount, safeAppsViewMode, setSafeAppsViewMode, modal }: SafeAppsListHeaderProps & { modal?: boolean }) => {
  return (
    <Stack paddingTop={modal ? 3 : 0} display="flex" flexDirection="row" justifyContent="space-between">
      {/* Safe Apps count */}
